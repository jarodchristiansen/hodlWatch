...
const TermsOfServicePage = () => {
  return (
    <TermsContainer>
      ...
      <span>
        These terms and conditions are the agreement between you as a "User"
        (also referred to herein as "you" and "your") of the website
        www.hodl-watch.vercel.app/ By accepting these Terms and Conditions on
        the Websites by means of clicking the "I accept" button or another
        affirmatory action, you are consenting to these Terms and Conditions
        that may be amended from time to time as set forth herein. Please review
        our Privacy Notice located at www.hodl-watch.vercel.app//privacy-notice,
        which is incorporated into these Terms and Conditions by this reference
        and therefore an integral part thereof.
      </span>
      ...
      <span>
        ...
        code to another person and "mirror" the materials to another server. You
        shall be responsible for ensuring the accuracy, completeness, legality
        and appropriateness of any information provided by you to us. You will
        ensure that you have sole knowledge of your passwords / username and
        that the security (secrecy) of passwords and username in connection with
        the Service is guaranteed at any time. In particular, you may not
        disclose or otherwise make them available to any other person. It is
        always assumed that you are the user of your password and username and
        bear full responsibility to all use and access to the Service. You are
        obliged to inform us immediately, if you become aware of a possible
        breach of data security, such as f.e. the unauthorized disclosure or use
        of your password. You acknowledge that: - We do not provide investment
        advice and that you will not treat any of the Service’s content as such;
        - We do not recommend any financial product; - We not recommend that any
        financial product should be bought, sold or held by you; - the
        information which may be referred to in the Service may not be suitable
        for you and that you should not make any investment decision without
      ...
      <span>
        ...
        or another party's intellectual property rights purpose; - to solicit
        others to use the Service for an unlawful or illegal purpose; - to
        circumvent any laws or regulations; to infringe upon the rights of any
        other party; - to copy, reproduce, recompile, decompile, disassemble,
        reverse engineer, distribute, publish, display, perform, modify, upload
        to, create derivative works from, transmit, transfer, sell, license,
        upload, edit post, frame, link, or in any way exploit any part of the
        Service or its content, unless you have obtained prior written consent
        from us; - to use the Service or its content for any commercial purpose;
        - you may not use any of the materials contained in the Service other
        than for the non-commercial purpose of viewing, reading and retaining
        for reference; - to transmit or upload any viruses, malware or malicious
        code; to spam, phish or defraud other actual or potential other users of
        the Service; - to use or attempt to use any "scraper," "robot," "bot,"
        "spider," "data mining," "computer code," or any other automate device,
        program, tool, algorithm, process or methodology to access, acquire,
        copy, or monitor any portion of the Service, any data or content found
        on or accessed through the Service; - or for any purpose that is not
        consistent with these Terms and Conditions. The Service is not intended
        for the use of children under 18 and no such person is authorized to use
        them. By using the Service, you are representing that you are at least
        18 years old. By accessing or using the Service, you represent that you
        are of legal age to enter into legally binding agreements. You will use
        the Service at any time strictly in compliance with all applicable laws,
        rules and regulations. You may neither interfere with nor attempt to
        interfere with nor otherwise disrupt the proper working of the Service.
        You shall not by any means violate the security of the Service or
        attempt to gain unauthorized access to the Service and/or parts of the
        Service. You agree to use the Service solely for your own non-commercial
        purposes.
      </span>
      ...
      <span>
        ...
        CONTENT AND INFORMATION, ARE PROVIDED "AS IS" AND "AS AVAILABLE" ON A
        COMPLEMENTARY AND VOLUNTARY BASIS. HODLWATCH DOES NOT MAKE ANY EXPRESS
        OR IMPLIED WARRANTIES, REPRESENTATIONS OR ENDORSEMENTS WHATSOEVER WITH
        REGARD TO THE SERVICE. IN PARTICULAR, YOU AGREE THAT HODLWATCH ASSUMES
        NO WARRANTY FOR THE CORRECTNESS, ACCURACY AND COMPLETENESS OF THE
        SERVICE AND THE WEBSITE. HODLWATCH'S LIABILITY AND WARRANTY ARE LIMITED
        TO INTENT AND GROSS NEGLIGENCE. IN NO EVENT WILL HODLWATCH, ITS
        AFFILIATES, MEMBERS, MANAGERS, OFFICERS, EMPLOYEES, AGENTS OR THE
        ASSIGNEES OF SAME BE LIABLE FOR (I) ANY INCIDENTAL, CONSEQUENTIAL,
        INDIRECT SPECIAL, EXEMPLARY OR PUNITIVE DAMAGES (INCLUDING, BUT NOT
        LIMITED TO, DAMAGES FOR LOSS OF PROFITS, REVENUE OR ANTICIPATED PROFITS
        OR LOST BUSINESS, BUSINESS INTERRUPTION, REPUTATIONAL DAMAGE, LOSS OF
        PROGRAMS OR INFORMATION OR DATA, AND THE LIKE) ARISING OUT OF THE USE OF
        OR INABILITY TO USE THE SERVICE, INABILITY TO USE THE SERVICE, OR ANY
        INFORMATION PROVIDED ON OR DOWNLOADED FROM THE SERVICE, EVEN IF
        HODLWATCH HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSSES OR DAMAGES.
        OR (II) ANY CLAIM BASED ON ERRORS, OMISSIONS OR OTHER INACCURACIES IN
        THE SERVICE. EVEN THOUGHHODLWATCH STRIVES TO MAKE THE SERVICE AVAILABLE
        24/7, HODLWATCH DOES NOT GUARANTEE UNINTERRUPTED AVAILABILITY OF THE
        SERVICE AND SHALL NOT BE LIABLE FOR ANY DELAYS, ERRORS OR INTERRUPTIONS
        IN THE TRANSMISSION OR DELIVERY OF DATA VIA THE SERVICE. HODLWATCH DOES
        NOT WARRANT THAT THE SERVICE AND THE WEBSITE ARE FREE OF VIRUSES, WORMS
        OR "TROJAN HORSES," OR ANY OTHER HARMFUL, INVASIVE, OR CORRUPTED FILES,
        OR OTHER HARMFUL COMPONENTS OR THAT THIS WEBSITE OR THE SERVICE DO NOT
        VIOLATE ANY THIRD PARTY RIGHTS. HODLWATCH HEREBY EXCLUDES ALL WARRANTY
        AND GUARANTEES TO THE FULLEST EXTENT PERMITTED BY LAW. BY USING THE
        SERVICE, YOU ACKNOWLEDGE AND AGREE THAT INTERNET TRANSMISSIONS ARE NEVER
        COMPLETELY PRIVATE OR SECURE. YOU UNDERSTAND THAT TRANSMISSIONS TO OR
        THROUGH THE SERVICE MAY BE INTERCEPTED BY OTHERS, AND YOU ASSUME THE
      ...
      <span>
        ...
        (I.E., RECOMMENDATIONS AS TO WHETHER OR NOT TO "BUY", "SELL", "HOLD", OR
        TO ENTER OR NOT TO ENTER INTO ANY OTHER TRANSACTION INVOLVING ANY
        CRYPTOCURRENCY). ALL INFORMATION PROVIDED BYHODLWATCH IS IMPERSONAL AND
        NOT TAILORED TO YOUR NEEDS.HODLWATCH DOES NOT EXPRESS ANY OPINION ON THE
        FUTURE OR EXPECTED VALUE OF ANY CRYPTOCURRENCY AND HODLWATCH DOES NOT
        EXPLICITLY OR IMPLICITLY RECOMMEND OR SUGGEST AN INVESTMENT STRATEGY OF
        ANY KIND. BY USING THE WEBSITE AND SERVICE YOU ACKNOWLEDGE THESE
        DISCLAIMERS. THE INFORMATION PROVIDED RELATES TO A DYNAMIC, HIGH RISK
        TYPE OF CURRENCY AND IS SUBJECT TO PERMANENT CHANGE. CRYPTOCURRENCY IS
        NEITHER SUBJECT TO A CENTRALIZED REGULATION BODY NOR IS BACKED BY ANY
        CORRESPONDING VALUE SUCH AS, E.G., COMPANY SHARES, RAW MATERIALS, GOLD.
        ACCORDINGLY, ANY CRYPTOCURRENCY IS A HIGHRISK INVESTMENT, WHICH MAY
        RESULT IN TOTAL LOSS OF ITS VALUE AND SOLELY SUBJECT TO THE DYNAMICS OF
        THE MARKET AND THE LEVEL OF DEMAND AND SUPPLY. ITS VALUE IS VULNERABLE
        TO STRONG FLUCTUATIONS AND MIGHT EVEN INVOLVE ARBITRARY CHANGES THAT ARE
        NOT FORESEEABLE. UNDER THESE CIRCUMSTANCES A STRONG LEVEL OF DISCRETION,
      ...
      <span>
        ...
        expenses (including reasonable attorneys’ fees and court costs), made
        against us by any third party due to or arising out of or in connection
        with (1) your access to or use of the Service; (2) your violation of
        these Terms and Conditions or any applicable law or regulation, (3) your
        violation of any rights of any third party thereto; or (4) any disputes
        or issues between you and any third party thereto.
      </span>
      ...
      <span>
        ...
        "Subscription Period"). We may terminate the provision of the Service to
        you with immediate effect and deactivate your access to the Service
        including the Website, if we have knowledge of or reasonably believe
        that your use of the Service and/or the Websites is in breach of
