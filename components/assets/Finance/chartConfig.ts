import { ChartColors, Colors } from "@/styles/variables";
...
export const chartConfig: ChartConfig[] = [
  ...
  },
  {
    ...
    dataSelector: (data) => data?.closes,
    showByDefault: true,
    headerStyle: { color: ChartColors.negative },
    description:
  ...
  },
  {
    ...
    dataSelector: (data) => data?.closes,
    showByDefault: true,
    headerStyle: { color: ChartColors.seriesMuted },
  ...
  },
  {
    ...
    dataSelector: (data) => data?.closes,
    showByDefault: true,
    headerStyle: { color: ChartColors.seriesCool },
